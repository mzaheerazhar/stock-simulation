...
urlpatterns = [
    ...
    path("transactions/", TransactionAPIView.as_view({"post": "create"}), name="transaction"),
    path("transactions/<str:user_id>/", TransactionByUserAPIView.as_view(), name="transaction"),
    path("transactions/<str:user_id>/<str:start>/<str:end>/", TransactionByUserAndDateAPIView.as_view(), name="transactions"),
]
